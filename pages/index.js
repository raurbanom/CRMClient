  ...
  return (
    < div >
      <Layout>
        ...
        <Link href="/newclient">
          <a className='bg-gray-800 py-2 px-5 mt-3 inline-block text-white rounded text-sm hover:bg-gray-900 mb-3 uppercase font-bold w-full lg:w-auto text-center'>New Client</a>
        </Link>
